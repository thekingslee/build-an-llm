# src/data/datasets/local.py
# Loads a local JSONL or JSON file with {instruction, input?, output} rows.
# Use this for custom or proprietary datasets that are not on HuggingFace.
